...
$settings['site_name'] = "Siggy Llama's Block'Em OBBLM/NAFLM portal"; // Site name.
...
$settings['league_coordinator_email'] = 'semantic@happypanic.net';    // Sent "Request League" e-mails
...
$rules['force_IR'] = true; // Default is false. Setting this to true will remove the ability of selecting 0-0 as 2D6 injury rolls (IR) in match reports (of all leagues).
...
// Rule #1
$hrs[1]['rule']   = array('-pts', '-sdiff', '-win_pct');    // Sort teams against: most points, then largest TD differential, then highest win %.
